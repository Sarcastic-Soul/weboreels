...
function app() {
    ...
    class RoadChunk {
        constructor(zSpaces) {
            ...
            let lineGeo = new THREE.PlaneGeometry(lineWidth, chunkSize),
            ...
            let dotLineGeo = new THREE.PlaneGeometry(lineWidth, lineHeight),
    ...
    class Car {
        constructor(color, x, z, name) {
            ...
            var carBodyBase = new THREE.Mesh(new THREE.BoxGeometry(5, 3, 10)),
                cutFront = new THREE.Mesh(new THREE.BoxGeometry(5, 1, 3)),
                cutBack = new THREE.Mesh(new THREE.BoxGeometry(5, 1, 2)),
                frontTireHoles = new THREE.Mesh(new THREE.CylinderGeometry(1.2, 1.2, 5, 16, 16, false)),
            ...
            var wheelGeo = new THREE.CylinderGeometry(1, 1, 0.5, 24, 24, false),
            ...
            var lightGeo = new THREE.PlaneGeometry(1, 0.5),
    ...
    class Truck {
        constructor(color, x, z, name) {
            ...
            var truckBodyBase = new THREE.Mesh(new THREE.BoxGeometry(5, 4, 10)),
                cutFront = new THREE.Mesh(new THREE.BoxGeometry(5, 1.5, 2.5)),
                cutBack = new THREE.Mesh(new THREE.BoxGeometry(5, 1.5, 4.5)),
                frontTireHoles = new THREE.Mesh(new THREE.CylinderGeometry(1.2, 1.2, 5, 16, 16, false)),
                backTireHoles = frontTireHoles.clone(),
                trunk = new THREE.Mesh(new THREE.BoxGeometry(4.4, 1.5, 4));
            ...
            var windowMat = new THREE.MeshLambertMaterial({
                ...
                horzWindowGeo = new THREE.PlaneGeometry(4.4, 1.2),
                horzWindowMat = windowMat,
                horzWindow = new THREE.Mesh(horzWindowGeo, horzWindowMat),

                midFrontWindowGeo = new THREE.PlaneGeometry(1.4, 1.2),
                midFrontWindowMat = windowMat,
                midFrontWindow = new THREE.Mesh(midFrontWindowGeo, midFrontWindowMat),

                midBackWindowGeo = new THREE.PlaneGeometry(1, 1.2),
                midBackWindowMat = windowMat,
                midBackWindow = new THREE.Mesh(midBackWindowGeo, midBackWindowMat);
            ...
            var lightGeo = new THREE.PlaneGeometry(0.75, 1),
                frontLightMat = new THREE.MeshLambertMaterial({
                    color: 0xf1f1f1
                }),
                frontLight = new THREE.Mesh(lightGeo, frontLightMat),
    ...
    class TractorTrailer {
        constructor(color, x, z, name) {
            ...
            var cabPt1Geo = new THREE.BoxGeometry(5, 4, 5),
            ...
            var cabPt2Geo = new THREE.BoxGeometry(5, 2, 0.5),
                cabPt2Mat = cabPt1Mat,
            ...
            var cabPt3Geo = new THREE.BoxGeometry(3, 2, 8.25),
            ...
            var cabLeftWindowGeo = new THREE.PlaneGeometry(2.5, 2),
            ...
            var cabFrontWindowGeo = new THREE.PlaneGeometry(5, 2),
            ...
            var lightGeo = new THREE.PlaneGeometry(1, 1),
            ...
            var cabLeftCylinderGeo = new THREE.CylinderGeometry(0.75, 0.75, 2.25, 16, 16, false),
            ...
            var trailerGeo = new THREE.BoxGeometry(5, 5, 12),
            ...
            var trailerBottomGeo = new THREE.BoxGeometry(3, 2, 2),
            ...
            var wheelGeo = new THREE.CylinderGeometry(1.5, 1.5, 1, 24, 24, false),
                wheelMat = new THREE.MeshLambertMaterial({
                    color: 0x242424
                }),
                wheel = new THREE.Mesh(wheelGeo, wheelMat);
    ...
    class Spark {
        constructor(x, y, z, isHorz = false) {
            ...
            let particleGeo = new THREE.SphereGeometry(1, 16, 16),
    ...
    var init = () => {
        ...
        var firstChunkSize = roadChunks[0].chunkSize,
            ...
            grassGeo = new THREE.PlaneGeometry(400, grassDepth),
